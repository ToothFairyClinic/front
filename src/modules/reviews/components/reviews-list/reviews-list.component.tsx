...
export const ReviewsList: FC<ReviewsListProps> = ({ }) => {
  ...
  return (
    ...
    <div className="py-10  flex flex-col lg:px-20 px-0 gap-10">
      <h2 className="text-3xl text-darkGray dark:text-white"><a target="_blank" rel="noopener noreferrer" className="underline" href="https://www.google.com/maps/place/%D0%A1%D1%82%D0%BE%D0%BC%D0%B0%D1%82%D0%BE%D0%BB%D0%BE%D0%B3%D1%96%D1%8F+%22%D0%97%D1%83%D0%B1%D0%BD%D0%B0+%D0%A4%D0%B5%D1%8F%22/@49.811069,30.1081881,17z/data=!4m18!1m9!3m8!1s0x40d3423b8b64085d:0x888f51696df6de26!2z0KHRgtC-0LzQsNGC0L7Qu9C-0LPRltGPICLQl9GD0LHQvdCwINCk0LXRjyI!8m2!3d49.811069!4d30.1081881!9m1!1b1!16s%2Fg%2F11c7s7p8z0!3m7!1s0x40d3423b8b64085d:0x888f51696df6de26!8m2!3d49.811069!4d30.1081881!9m1!1b1!16s%2Fg%2F11c7s7p8z0?hl=ru&entry=ttu">{t("Наші попередні відгуки доступні")} {t("Тут")}</a></h2>
      <OldReviewsItem />
      <div className=" lg:px-20 px-0 ">
        ...
        >
          {data.reviews.map(({ ...item }) => (
            <SwiperSlide key={item.id} className="mb-12 " tag="article">
              <ReviewsItem  {...item} />
            </SwiperSlide>
          ))}
        </Swiper>
